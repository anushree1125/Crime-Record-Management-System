...
<html lang="en">
  ...
  $sq = "SELECT user_name from user WHERE user_id='".$user_id."'";
  $res3 = $conn->query($sq);
  ...
  $sql2="SELECT user_id,user_name from user";
    ...
    <div>
      <form class="form" action="edit_sql.php">
        ...
        <select
          ...
          id="exampleFormControlSelect1" required
        >
        <option value="<?php echo $row['user_id'];?>"><?php echo $user_id ."-". $user_name;?></option>
        <?php 
        
         while($row2=$result2->fetch_assoc()){
          ?>
          <option value="<?php echo $row2['user_id'];?>"><?php echo $row2['user_id'] ."-". $row2['user_name'];?></option>
       <?php
         }
         ?>
        </select>
        ...
        <select name="case_status" class="form-control" id="exampleFormControlSelect1"required>
          <option value="<?php echo $row['case_status'];?>"><?php echo $case_status;?></option>
